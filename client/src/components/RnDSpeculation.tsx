...
const APPROACHES: Approach[] = [
  {
    ...
    trl: 4,
    status: "DEMONSTRATED",
    tagline: "Relevant analogy (not a propulsion method) — demonstrates m* < 0 in cold-atom systems only",
    ...
    gap: "Operates at ~100 nK, requires ultra-high vacuum and laser cooling infrastructure. The 'negative mass' is a band-structure effect — gravitational mass is completely unchanged. These experiments do not create gravitational repulsion and there is no known path to macroscopic or room-temperature operation.",
  ...
  },
  {
    ...
    trl: 3,
    status: "DEMONSTRATED",
    tagline: "Relevant analogy (not a propulsion method) — wave-propagation effect, not gravitational",
    ...
    gap: "Effect is frequency-specific, narrow-band, and applies only to wave propagation in structured media — not to the gravitational or inertial mass of the bulk object. These experiments demonstrate negative effective mass density for acoustic waves; they do not create gravitational repulsion. No mechanism to extend to broadband or DC (static) force response.",
